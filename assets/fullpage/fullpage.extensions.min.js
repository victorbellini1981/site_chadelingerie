...
!function(e, t, n, o, i) {
    ...
    function(Y, Z) {
        ...
        if (!J(_("html"), a)) {
            ...
            var be, ke, Ie, ze, Be = !1, Ne = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), je = "ontouchstart"in e || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Pe = "string" == typeof Y ? _(Y)[0] : Y, Ye = K(), De = !1, We = !0, Ve = !0, Xe = [], Ze = {
                m: {
                    up: !0,
                    down: !0,
                    left: !0,
            ...
            }, nt = !1, ot = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]', it = Q({}, Z), rt = {};
            so(),
            ...
            ve.destroy = function(n) {
                ...
                clearTimeout(Fe),
                n && ($n(0),
                _("img[data-src], source[data-src], audio[data-src], iframe[data-src]", Pe).forEach(function(e) {
                    on(e, "src")
                }),
            ...
            ve.test = {
                ...
                translate3dH: function() {
                    for (var e = [], t = 0; t < _(Z.sectionSelector, Pe).length; t++)
            ...
            function() {
                ...
                Ye = K(),
                de(Pe, l),
                ue(_(Z.sectionSelector, Pe), p),
                ue(_(Z.slideSelector, Pe), T),
                io("parallax", "init");
                for (var e = _(h), i = 0; i < e.length; i++) {
                    ...
                    f = s,
                    v = r,
                    void 0 !== Z.anchors[v] && J(f, c) && jn(Z.anchors[v], v),
                ...
                Z.navigation && function() {
                    ...
                    for (var i = "", r = 0; r < _(h).length; r++) {
                        var l = "";
                        Z.anchors.length && (l = Z.anchors[r]),
                        i += '<li><a href="#' + l + '"><span></span></a>';
                        var a = Z.navigationTooltips[r];
                        void 0 !== a && "" !== a && (i += '<div class="' + x + " fp-" + Z.navigationPosition + '">' + a + "</div>"),
                        i += "</li>"
                    }
                    _("ul", o)[0].innerHTML = i,
                    q(_(E), {
                ...
                Z.scrollOverflow ? Ge = Z.scrollOverflowHandler.init(Z) : Pt()
            }(),
            xt(!0),
        ...
        function Et(n) {
            ...
            Pe.addEventListener("mousedown", En),
            Pe.addEventListener("mouseup", xn)) : (t.addEventListener ? (t.removeEventListener("mousewheel", Ft, !1),
            t.removeEventListener("wheel", Ft, !1),
            t.removeEventListener("MozMousePixelScroll", Ft, !1)) : t.detachEvent("onmousewheel", Ft),
            Pe.removeEventListener("mousedown", En),
            Pe.removeEventListener("mouseup", xn))
        }
        function xt(e, t) {
            ...
            e ? (Et(!0),
            (Ne || je) && (Z.autoScrolling && (ce.removeEventListener(tt.touchmove, Vt, {
                passive: !1
            }),
            ...
            (Ne || je) && (Z.autoScrolling && (ce.removeEventListener(tt.touchmove, Xt, {
                passive: !1
            }),
        ...
        function At() {
            var e = ee(_(g)[0], h);
            e || !Z.loopTop && !Z.continuousVertical || (e = ie(_(h))),
            null != e && Kt(e, null, !0)
        }
        function Mt() {
            var e = te(_(g)[0], h);
        ...
        function Ht(t) {
            if (!J(Pe, l)) {
                ...
                De = !1,
                xe(Z.afterResize) && t && Z.afterResize.call(Pe, e.innerWidth, e.innerHeight),
                xe(Z.afterReBuild) && !t && Z.afterReBuild.call(Pe),
                Le(Pe, "afterRebuild")
            }
        }
        function Rt(e) {
            ...
            ae(_(E)),
            ue(ce, i),
            xe(Z.afterResponsive) && Z.afterResponsive.call(Pe, e),
            Z.responsiveSlides && ve.responsiveSlides && ve.responsiveSlides.toSections(),
            Le(Pe, "afterResponsive", e)) : t && (St(it.autoScrolling, "internal"),
            wt(it.autoScrolling, "internal"),
            se(_(E)),
            de(ce, i),
            xe(Z.afterResponsive) && Z.afterResponsive.call(Pe, e),
            Z.responsiveSlides && ve.responsiveSlides && ve.responsiveSlides.toSlides(),
            Le(Pe, "afterResponsive", e))
        }
        function It(e, n) {
            t["fp_" + e] = n,
        ...
        function Nt(e, n, o) {
            ...
            var d = _(k, e)[0];
            null != d && (0 !== re(_(g), h) || 0 === re(_(g), h) && 0 !== re(d)) ? (qn(d, "internal"),
            ue(d, B)) : ue(n[0], c)
        }
        function jt(e) {
        ...
        function Yt() {
            ...
            (!Z.autoScrolling || Z.scrollBar || oo("dragAndMove")) && !lo()) {
                ...
                if (!J(e = r[n], c)) {
                    ct = !0;
                    var a, s, u = _(g)[0], d = re(u, h) + 1, f = Pn(e), v = e.getAttribute("data-anchor"), p = re(e, h) + 1, m = _(k, e)[0], S = {
                        activeSection: u,
                        sectionIndex: p - 1,
                        anchorLink: v,
                        element: e,
        ...
        function Ft(t) {
            ...
            if (Z.autoScrolling && !Ie && !o) {
                ...
                return pt = n,
                s > 200 && (Xe = []),
                Ve && !ro() && Ut(Xe, 10) >= Ut(Xe, 70) && a && Wt(r < 0 ? "down" : "up"),
                !1
            }
            Z.fitToSection && ($e = !1)
        }
        ...
        function Jt(e) {
            ...
            return t > Ye ? (i || l) && "bottom" !== l || (o = r) : (i || De && null == oe(e)) && (o = r),
            Z.offsetSections && ve.offsetSections && (o = ve.offsetSections.getSectionPosition(i, o, e)),
            ht = o,
            o
        }
        function Kt(e, t, n) {
            if (null != e) {
                ...
                if (!(l.activeSection == e && !De || Z.scrollBar && ye() === l.dtop && !J(e, b))) {
                    if (null != l.activeSlide && (i = l.activeSlide.getAttribute("data-anchor"),
                    r = re(l.activeSlide)),
                    ...
                    u.yMovement = Pn(u.element),
                    u.leavingSection = re(u.activeSection, h) + 1,
                    u.sectionIndex = re(u.element, h),
                    ...
                    Un(r, i, l.anchorLink, l.sectionIndex),
                    function(e) {
                    ...
                    be = l.anchorLink,
                    jn(l.anchorLink, null != (s = l).wrapAroundElements ? s.isMovementUp ? _(h).length - 1 : 0 : s.sectionIndex)
                }
            }
            var s, u
        }
        ...
        function nn(e) {
            ...
            $n(_(g)[0].offsetTop),
            Qt(),
            t.sectionIndex = re(t.element, h),
            t.leavingSection = re(t.activeSection, h) + 1),
        ...
        function un(e) {
            ...
            function n(e) {
                var n, o, i, r, l, a, s = "", c = 0;
                for (e = e.replace(/[^A-Za-z0-9+/=]/g, ""); c < e.length; )
                    n = t.indexOf(e.charAt(c++)) << 2 | (r = t.indexOf(e.charAt(c++))) >> 4,
                    o = (15 & r) << 4 | (l = t.indexOf(e.charAt(c++))) >> 2,
                    i = (3 & l) << 6 | (a = t.indexOf(e.charAt(c++))),
                    s += String.fromCharCode(n),
                    64 != l && (s += String.fromCharCode(o)),
                    64 != a && (s += String.fromCharCode(i));
                return s = function(e) {
                    for (var t, n = "", o = 0, i = 0, r = 0; o < e.length; )
                        (i = e.charCodeAt(o)) < 128 ? (n += String.fromCharCode(i),
                        o++) : i > 191 && i < 224 ? (r = e.charCodeAt(o + 1),
                        n += String.fromCharCode((31 & i) << 6 | 63 & r),
                        o += 2) : (r = e.charCodeAt(o + 1),
                        t = e.charCodeAt(o + 2),
                        n += String.fromCharCode((15 & i) << 12 | (63 & r) << 6 | 63 & t),
                        o += 3);
                    return n
                }(s)
            }
        ...
        function pn(n) {
            ...
            lt = un("MTIzPGRpdj48YSBocmVmPSJodHRwOi8vYWx2YXJvdHJpZ28uY29tL2Z1bGxQYWdlL2V4dGVuc2lvbnMvIiBzdHlsZT0iY29sb3I6ICNmZmYgIWltcG9ydGFudDsgdGV4dC1kZWNvcmF0aW9uOm5vbmUgIWltcG9ydGFudDsiPlVubGljZW5zZWQgZnVsbFBhZ2UuanMgRXh0ZW5zaW9uPC9hPjwvZGl2PjEyMw=="),
            at.innerHTML = lt,
            at = at.firstChild,
        ...
        function hn() {
            ...
            nt = !0),
            at.setAttribute("style", un("").replace(/;/g, un("MTIzICFpbXBvcnRhbnQ7MzQ1"))))
        }
        function gn() {
            var e = Sn()
              , t = e.section
        ...
        function En(e) {
            ...
            Pe.addEventListener("mousemove", On))
        }
        function xn(e) {
        ...
        function kn(e, t, n) {
            ...
            i.xMovement = Yn(i.prevSlideIndex, i.slideIndex),
            i.localIsResizing || (Ve = !1),
            io("parallax", "applyHorizontal", i),
            Z.onSlideLeave && !i.localIsResizing && "none" !== i.xMovement && xe(Z.onSlideLeave) && !1 === qt("onSlideLeave", i) ? Be = !1 : (ue(t, c),
            de(we(t), c),
            i.localIsResizing || (sn(i.prevSlide),
            rn(t)),
            Cn(i),
            J(o, c) && !i.localIsResizing && Un(i.slideIndex, i.slideAnchor, i.anchorLink, i.sectionIndex),
            ve.continuousHorizontal && ve.continuousHorizontal.apply(i),
            lo() ? Hn(i) : Rn(e, i, !0),
            Z.interlockedSlides && ve.interlockedSlides && (oo("continuousHorizontal") && void 0 !== n && n !== i.xMovement || ve.interlockedSlides.apply(i)))
        }
        function Cn(e) {
        ...
        function Hn(e) {
            ...
            ue(_("a", _("li", t)[n]), c)),
            e.localIsResizing || (io("parallax", "afterSlideLoads"),
        ...
        function Rn(e, t, n) {
            ...
            if (Z.css3) {
                ...
                ve.test.translate3dH[t.sectionIndex] = i,
                q(Bn(_(I, e)), eo(i)),
        ...
        function jn(e, t) {
            ...
            ue(i ? _('a[href="#' + i + '"]', _(E)[0]) : _("a", _("li", _(E)[0])[r]), c))
        }
        function Pn(e) {
            var t = re(_(g)[0], h)
              , n = re(e, h);
        ...
        function Zn(e, t) {
            var n = Xn(e);
            if (null != n) {
                var o, i, r, l = (null == (r = _(O + '[data-anchor="' + (o = t) + '"]', i = n)[0]) && (o = void 0 !== o ? o : 0,
                r = _(O, i)[o]),
                r);
        ...
        function Un(e, t, n, o) {
            var i = "";
            Z.anchors.length && !Z.lockAnchors && (e ? (null != n && (i = n),
            null == t && (t = e),
            ke = t,
            Fn(i + "/" + t)) : null != e ? (ke = t,
            Fn(n)) : Fn(n)),
        ...
        function Qn() {
            ...
            ce.className = ce.className.replace(r, ""),
            ue(ce, s + "-" + i)
        }
        function Jn() {
        ...
        function Kn(e) {
            ...
            je && Zt(e) && Z.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY,
        ...
        function co(t, n, o, i) {
            var r, l = (r = t).self != e && J(r, C) ? r.scrollLeft : !Z.autoScrolling || Z.scrollBar ? ye() : r.offsetTop, a = n - l, s = 0;
            $e = !0;
            var c = function() {
                if ($e) {
                    var r = n;
                    s += 20,
                    o && (r = e.fp_easings[Z.easing](s, l, a, o)),
                    uo(t, r),
